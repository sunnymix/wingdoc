...
export default forwardRef((props: ImagerProps, ref) => {
  ...
  const handleRemove = useCallback((e: any) => {
    BlockApi.updateBlock(props.blockId, { img: '' }, () => {
      setImg('');
    });
  }, []);
